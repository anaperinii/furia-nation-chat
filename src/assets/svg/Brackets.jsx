    ...
    >
      ...
      <defs>
        <linearGradient id="brackets-left" x1="50%" x2="50%" y1="0%" y2="100%">
          <stop offset="0%" stopColor="#FF9A5A" /> {/* Laranja claro */}
          <stop offset="100%" stopColor="#FF2D75" /> {/* Rosa-vermelho */}
        </linearGradient>
      </defs>
    </svg>
  ) : (
    ...
    >
      ...
      <defs>
        <linearGradient
          ...
          y2="100%"
        >
          <stop offset="0%" stopColor="#FF7B25" /> {/* Laranja */}
          <stop offset="100%" stopColor="#FFCC33" /> {/* Amarelo */}
        </linearGradient>
      </defs>
    </svg>
  );
